		...
		<div class="card mb-4 wow fadeIn">
			...
			<div class="card-body d-sm-flex justify-content-between">
				...
				<h4 class="mb-2 mb-sm-0 pt-1">
					<a href="https://mdbootstrap.com/docs/jquery/" target="_blank">Home
			...
			<div class="col-md-6 mb-4">
				...
				<div class="card">
					...
					<section>
									...
									<div class="modal-body">
										<div class="text-center">
											...
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing
												...
												in dolores culpa, dignissimos, eius non possimus fugiat.
						...
						<div class="modal fade left" id="sideModalTLInfoDemo"
							tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
							aria-hidden="true" data-backdrop="false">
							<div
	...
	<footer
		...
		<div class="pb-4">
			<a href="https://www.facebook.com/mdbootstrap" target="_blank"> <i
				...
				target="_blank"> <i class="fab fa-google-plus mr-3"></i>
